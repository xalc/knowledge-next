          ...
          <div key={monthName} className="space-y-2">
            ...
            <div className="grid grid-cols-7 text-sm gap-1">
              ...
              {generateMonthGrid(year, monthIndex).map(({ date, isCurrentMonth }, index) => {
                ...
                const isSelected = selectedDate && formatDate(date) === formatDate(selectedDate) && isCurrentMonth
                  ...
                  <TooltipProvider key={index}>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          className={cn(
                            "flex flex-col items-center justify-center p-0.5 relative hover:bg-accent rounded-sm transition-colors",
                        ...
                        >
                          ...
                          {isCurrentMonth && holidayInfo && (
                            ...
                            >
                              <span className={cn(
                                holidayInfo.type === 'holiday' ? 'text-red-500 dark:text-red-400' : 'text-blue-500 dark:text-blue-400'
                              )}>
